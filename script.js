...
const allProducts = {
  ...
  store: [
    {id: 101, name:"MacBook Air M4", price:800000, category:"mac", image:"mac-1.png", desc:"Ultraléger, écran Liquid Retina."},
    {id: 102, name:"iPad Pro", price:600000, category:"ipad", image:"ipad-1.png", desc:"Puissance X-Series, design fin."},
    {id: 103, name:"iPhone 17 Pro", price:900000, category:"iphone", image:"iphone-1.png", desc:"Design premium et caméra avancée."},
    {id: 104, name:"Watch SE", price:180000, category:"watch", image:"watch-3.png", desc:"Essentiel, rapide et très abordable."},
  ],
  mac: [
  ...
  iphone: [
    {id: 401, name:"iPhone 11", price:110000, category:"iphone", image:"iphone-4.png", desc:"Abordable, fiable et polyvalent."},    
    {id: 402, name:"iPhone Air", price:150000, category:"iphone", image:"iphone-3.png", desc:"Performances Pro dans un format léger."},
    {id: 403, name:"iPhone 17 Pro", price:900000, category:"iphone", image:"iphone-1.png", desc:"Design premium et caméra avancée."},
    {id: 404, name:"iPhone 16 Pro", price:500000, category:"iphone", image:"Iphone-hero.png", desc:"Grand écran et excellente autonomie."},
  ],
  watch: [
    ...
    {id: 503, name:"Watch Ultra 2", price:500000, category:"watch", image:"watch-4.png", desc:"Résistante, sportive et précise."},
    {id: 504, name:"Watch Studio", price:150000, category:"watch", image:"watch-1.png", desc:"Style personnalisable et performant."}
  ],
  vision: [
    {id: 1001, name:"Vision Pro", price:2500000, category:"support", image:"vision.png", desc:"Immersion extrême, puce M5 et confort total."},
    {id: 1002, name:"Solo Knit Band", price:50000, category:"support", image:"vision1.png", desc:"Confort, respirabilité et maintien optimal."},
    {id: 1003, name:"Apple Vision Pro", price:2500000, category:"support", image:"vision2.png", desc:"Collaboration immersive et multitâche avancé."},
  ],
  airpods: [
    {id: 601, name:"AirPods Pro 2", price:150000, category:"airpods", image:"air-pod-pro2.png", desc:"ANC avancé et audio spatial immersif."},
    {id: 602, name:"AirPods 3", price:100000, category:"airpods", image:"air-pod.png", desc:"Son riche avec capteur de pression."},
    {id: 603, name:"Beats Studio", price:200000, category:"airpods", image:"beat-studio.png", desc:"Son puissant et réduction active du bruit."},
    {id: 604, name:"AirPods Max", price:350000, category:"airpods", image:"air-pod-max.png", desc:"Casque premium à haute fidélité."}
  ],
  tvhome: [
    {id: 701, name:"Apple TV 4K", price:100000, category:"tvhome", image:"apple_tv_4k.png", desc:"Streaming 4K, HDR et Apple TV OS."},
    {id: 702, name:"HomePod mini", price:50000, category:"tvhome", image:"home-pod-mini.png", desc:"Assistant intelligent et son immersif."},
    {id: 703, name:"Apple Remote", price:30000, category:"tvhome", image:"comfort.png", desc:"Télécommande modernisée."},
    {id: 704, name:"Home App", price:1000, category:"tvhome", image:"home-app.png", desc:"Total contrôle de la maison connectée."}
  ],
  entertainment: [
    
  ],
  accessories: [
    {id: 901, name:"EvoPop Case", price:25000, category:"accessories", image:"accessoire1.png", desc:"Coque antichoc premium."},
    {id: 902, name:"HidrateSpark Pro", price:80000, category:"accessories", image:"accessoire2.png", desc:"Gourde connectée intelligente."},
    {id: 903, name:"Crossbody Strap", price:40000, category:"accessories", image:"accessoire4.png", desc:"Bandoulière élégante et robuste."},
    {id: 904, name:"Herschel Cloud", price:55000, category:"accessories", image:"accessoire6.png", desc:"Organiseur tech élégant."}
  ],
  support: [
